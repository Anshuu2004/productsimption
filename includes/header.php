...
if (isset($_SESSION['enquiry']) && is_array($_SESSION['enquiry'])) {
    foreach ($_SESSION['enquiry'] as $item) {
...
<head>
    ...
    <script>
        const BASE_URL = '<?php echo rtrim(str_replace($_SERVER["DOCUMENT_ROOT"], "", str_replace("\\", "/", __DIR__ . "/..")), "/"); ?>/';
    </script>
    ...
    <script src="assets/js/modern-filter.js" defer></script>
</head>
<body>
        ...
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <div>
                <?php if (isset($_SESSION['user'])): ?>
                    ...
                    <a href="wishlist.php" class="text-decoration-none text-dark me-3"><i class="fas fa-heart me-1"></i> Wishlist</a>
...
<header class="bg-white shadow-sm sticky-top" id="mainHeader" style="z-index: 1050;">
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <!-- Logo -->
            <a class="navbar-brand" href="home-new.php">
                ...
                <form action="search.php" method="GET" class="input-group">
                    ...
                    <button class="btn btn-outline-secondary" type="submit"><i class="fas fa-search"></i></button>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="quote-new.php" class="btn btn-primary me-2 d-none d-lg-block">Order in Bulk</a>
                                        ...
                                        <button class="btn btn-outline-primary me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas" aria-controls="filterOffcanvas">
                                        ...
                                        <div class="d-none d-lg-block">
                                             ...
                                             <select class="form-select" name="sort" onchange="document.getElementById('filter-form').submit();" form="filter-form" style="width: auto;">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav mx-auto justify-content-center mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="home-new.php">Home</a></li>
                    
                    <!-- All Products Dropdown -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="products-new.php" id="allProductsDropdown" role="button">All Products</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="mega-menu-links">
                                                <h5>ID Cards</h5>
                                                <a href="product-new.php?id=2" data-image="assets/images/menu-featured/id-cards/pvc-card.jpg">PVC Card</a>
                                                <a href="product-new.php?id=4" data-image="assets/images/menu-featured/id-cards/pouch-card.jpg">Pouch Card</a>
                                                <a href="product-new.php?id=5" data-image="assets/images/menu-featured/id-cards/uv-card.jpg">UV-Card</a>
                                                <a href="product-new.php?id=1" data-image="assets/images/menu-featured/id-cards/rfid-card.jpg">RFID-Card</a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mega-menu-links">
                                                <h5>Attendance</h5>
                                                <a href="product-new.php?attendance=11" data-image="assets/images/menu-featured/attendance/rfid-machine.jpg">RFID Machine</a>
                                                <a href="product-new.php?attendance=13" data-image="assets/images/menu-featured/attendance/fingerprint-machine.jpg">Fingerprint Machine</a>
                                                <a href="product-new.php?attendance=12" data-image="assets/images/menu-featured/attendance/face-scanner.jpg">Face Scanner</a>
                                                <a href="product-new.php?attendance=14" data-image="assets/images/menu-featured/attendance/qr-scanner.jpg">QR Scanner</a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mega-menu-links">
                                                <h5>Lanyards</h5>
                                                <a href="product-new.php?lanyard=3" data-image="assets/images/menu-featured/lanyards/polyester-lanyards.jpg">Polyester Lanyards</a>
                                                <a href="product-new.php?lanyard=7" data-image="assets/images/menu-featured/lanyards/nylon-lanyards.jpg">Nylon Lanyards</a>
                                                <a href="product-new.php?lanyard=8" data-image="assets/images/menu-featured/lanyards/lanyard-prints.jpg">Lanyard Prints</a>
                                                <a href="product-new.php?lanyard=9" data-image="assets/images/menu-featured/lanyards/customized-lanyards.jpg">Customized Lanyards</a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mega-menu-links">
                                                <h5>Badges</h5>
                                                <a href="product-new.php?badge=6" data-image="assets/images/menu-featured/badges/metal-badges.jpg">Metal Badges</a>
                                                <a href="product-new.php?badge=5" data-image="assets/images/menu-featured/badges/plastic-badges.jpg">Plastic Badges</a>
                                                <a href="product-new.php?badge=19" data-image="assets/images/menu-featured/badges/clip-badges.jpg">Clip Badges</a>
                                                <a href="product-new.php?badge=20" data-image="assets/images/menu-featured/badges/magnetic-badges.jpg">Magnetic Badges</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="mega-menu-links">
                                        ...
                                        <a href="product-new.php?attendance=13" data-image="assets/images/menu-featured/attendance/fingerprint-machine.jpg">Fingerprint Machine</a>
                                        <a href="product-new.php?attendance=12" data-image="assets/images/menu-featured/attendance/face-scanner.jpg">Face Scanner</a>
                                        <a href="product-new.php?attendance=12" data-image="assets/images/menu-featured/attendance/face-id-attendance-machine.jpg">Face ID Attendance Machine</a>
                                        <a href="product-new.php?attendance=14" data-image="assets/images/menu-featured/attendance/qr-scanner.jpg">QR Scanner</a>
                                        <a href="product-new.php?attendance=14" data-image="assets/images/menu-featured/attendance/barcode-scanner.jpg">Barcode Scanner</a>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="mega-menu-image">
                    ...
                    <li class="nav-item"><a class="nav-link" href="contact-new.php">Contact Us</a></li>
                </ul>
            </div>
        </div>
    </nav>
